  ...
  ?>
    ...
    <div class="container-fluid">
      ...
      <footer class="text-center mt-5 py-3">
        ...
        <p> Made by <b>JAI KHANDELWAL</b></p>
        <h3>   
          <a href="https://github.com/jaikhandelwal053/" target="_blank" class="github"><i class="bx bxl-github"></i></a>
          <a href="https://www.linkedin.com/in/jaikhandelwal/" target="_blank" class="linkedin"><i class="bx bxl-linkedin"></i></a>
          <a href="mailto: jaikhandelwal0987@gmail.com" target="_blank" class="email"><i class="bx bxs-envelope"></i></a>
        </h3>   
      </footer>
